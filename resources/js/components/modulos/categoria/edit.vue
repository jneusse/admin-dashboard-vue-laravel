        ...
        <div class="card-body">
            <div class="container-fluid">
                <div class="card card-info">
                    <div class="card-header">
                        <h3 class="card-title">Formuliario Editar Categoria</h3>
                    </div>
                    <div class="card-body">
                        <form role="form ">
                            <div class="row">
                    ...
                    <div class="card-footer">
                        <div class="row">
                            <div class="col-md-4 offset-4">
                                <button class="btn btn-flat btn-info btnWidth" v-loading.fullscreen.lock="fullscreenLoading" @click.prevent="setEditarCategoria">Guardar</button>
...
export default {
    ...
    methods:{
        ...
        setEditarCategoria(){
            ...
            let url = '/configuracion/categoria/setEditarCategoria'
